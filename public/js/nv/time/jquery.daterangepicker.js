...
(function(factory) {
    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        function init_datepicker() {
            ...
            var defaultTime2 = opt.defaultTime ? opt.defaultTime : new Date().setHours(23, 59, 59, 999);
            ...
            if (opt.time.enabled) {
                if ((opt.startDate && opt.endDate) || (opt.start && opt.end)) {
                    ...
                    var defaultEndTime = opt.defaultEndTime ? opt.defaultEndTime : defaultTime2;
        ...
        function getDefaultTime() {
            var defaultTime = opt.defaultTime ? opt.defaultTime : new Date().setHours(0,0,0,0);
            var defaultTime2 = opt.defaultTime ? opt.defaultTime : new Date().setHours(24,0,0,0);
            if (opt.lookBehind) {
