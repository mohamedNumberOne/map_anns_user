...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Modifier les utilisateurs</h1>
        <a href="{{route('users.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                class="fas fa-arrow-left fa-sm text-white-50"></i> Arrière</a>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Modifier les utilisateurs</h6>
        </div>
        <form method="POST" action="{{route('users.update', ['user' => $user->id])}}">
            ...
            <div class="card-body">
                <div class="form-group row">
                     ...
                     <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        <label> <span style="color:red;">*</span>Nom de famille</label>
                        <input 
                            type="text" 
                    ...
                    {{-- Numéro de portable --}}
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        <label> <span style="color:red;">*</span>Numéro de portable</label>
                        <input 
                            type="text" 
                    ...
                    <label> Mot de passe</label>
                        <input 
                            type="password" 
                            class="form-control form-control-user @error('new_confirm_password') is-invalid @enderror" 
                            id="exampleMobile"
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-success btn-user float-right mb-3">Mise à jour</button>
