...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('front/assets/leaflet-groupedlayercontrol/leaflet.groupedlayercontrol.css') }}">
  ...
  <body>
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">ANNS</a>
        </div>
    ...
    <script src="{{ asset('front/assets/leaflet-groupedlayercontrol/leaflet.groupedlayercontrol.js') }}"></script>
...
$.getJSON("{{ asset('front/assets/data/boroughs.geojson') }}", function (data) {
...
$.getJSON("{{ asset('front/data/subways.geojson') }}", function (data) {
...
var theaters = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "{{ asset('front/assets/img/theater.png') }}",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
...
$.getJSON("{{ asset('front/assets/data/DOITT_THEATER_01_13SEPT2010.geojson') }}", function (data) {
...
var museums = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "{{ asset('front/assets/img/museum.png') }}",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
...
$.getJSON("{{ asset('front/assets/data/DOITT_MUSEUM_01_13SEPT2010.geojson') }}", function (data) {
...
var groupedOverlays = {
  "Points of Interest": {
    "<img src='{{ asset('front/assets/img/theater.png') }}' width='24' height='28'>&nbsp;Theaters": theaterLayer,
    "<img src='{{ asset('front/assets/img/museum.png') }}' width='24' height='28'>&nbsp;Museums": museumLayer
  },
  "Reference": {
    "Boroughs": boroughs,
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='{{ asset('front/assets/img/museum.png') }}' width='24' height='28'>&nbsp;Museums</h4>",
      suggestion: Handlebars.compile(["${name}<br>&nbsp;<small>${address}</small>"].join(""))
    }
  }, {
    name: "GeoNames",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='{{ asset('front/assets/img/globe.png') }}' width='25' height='25'>&nbsp;GeoNames</h4>"
    }
